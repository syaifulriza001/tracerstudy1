...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2021 at 10:23 AM
...
--
-- Stand-in structure for view `aktiuser_v`
-- (See below for the actual view)
--
CREATE TABLE `aktiuser_v` (
`id` int(10)
,`id_user_grup` int(10)
,`nim` int(9)
...
INSERT INTO `testimoni` (`id_testi`, `id_user`, `testimoni`, `kritik_saran`) VALUES
(1, 78, 'sda', 'dsada');
...
(24, 1, 0, 'admin', 'keren', 'L', NULL, '', '', 'admin@gmail.com', '', '21232f297a57a5a', '', '', '', 'aktif'),
